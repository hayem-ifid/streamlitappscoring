...
st.title("Prédiction de défaut")
st.subheader("Crédit Populaire d'Algérie")
img = st.sidebar.image('download.jpg')
...
predict_button = st.button('Exécuter', on_click=predicter)
